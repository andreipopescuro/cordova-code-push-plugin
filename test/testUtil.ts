...
export class TestUtil {
  ...
  public static readTestRunDirectory(): string {
    var commandLineOption = TestUtil.readMochaCommandLineOption(
      TestUtil.TEST_RUN_DIRECTORY
    );
    var testRunDirectory = commandLineOption
      ? commandLineOption
      : TestUtil.defaultTestRunDirectory;
  ...
  public static readTestUpdatesDirectory(): string {
    var commandLineOption = TestUtil.readMochaCommandLineOption(
      TestUtil.TEST_UPDATES_DIRECTORY
    );
    var testUpdatesDirectory = commandLineOption
      ? commandLineOption
      : TestUtil.defaultUpdatesDirectory;
  ...
  public static readPluginPath(): string {
    var commandLineFlag = TestUtil.readMochaCommandLineFlag(
  ...
  public static readAndroidServerUrl(): string {
    var commandLineOption = TestUtil.readMochaCommandLineOption(
      TestUtil.ANDROID_SERVER_URL
    );
    var androidServerUrl = commandLineOption
      ? commandLineOption
      : TestUtil.defaultAndroidServerUrl;
  ...
  public static readIOSServerUrl(): string {
    var commandLineOption = TestUtil.readMochaCommandLineOption(
      TestUtil.IOS_SERVER_URL
    );
    var iOSServerUrl = commandLineOption
      ? commandLineOption
      : TestUtil.defaultIOSServerUrl;
    return iOSServerUrl;
  }
    ...
    if (commandLineOption) {
      ...
      this.getProcessOutput("xcrun simctl list")
        .then(function (listOfDevicesWithDevicePairs) {
          var listOfDevices: string = listOfDevicesWithDevicePairs.slice(
  ...
  public static readRestartEmulators(): boolean {
    var restartEmulators = TestUtil.readMochaCommandLineFlag(
      TestUtil.RESTART_EMULATORS
    );
  ...
  public static readCoreTestsOnly(): boolean {
    var coreTestsOnly = TestUtil.readMochaCommandLineFlag(
      TestUtil.CORE_TESTS_ONLY
    );
  ...
  public static readShouldUseWkWebView(): number {
    var shouldUseWkWebView = TestUtil.readMochaCommandLineOption(
      TestUtil.SHOULD_USE_WKWEBVIEW
    );
   ...
   */
  public static getProcessOutput(
    command: string,
